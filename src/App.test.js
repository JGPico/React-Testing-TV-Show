...
test("The app renders and fetches data", async () => {
    ...
    await waitFor(() => {
        expect(queryByTestId(/test-title/i)).toBeTruthy();
    })

    expect(mockFetchShow).toHaveBeenCalledTimes(1);

    // query for and click dropdown list
    const dropDown = queryByTestId(/test-drop/i);
